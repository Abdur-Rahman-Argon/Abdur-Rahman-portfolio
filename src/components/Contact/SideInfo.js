...
const SideInfo = () => {
  return (
    <div className="w-full mx-auto flex-1 text-center text-gray-700 py-4">
      <div className="w-full">
        <ul className="text-xl text-left">
          <li className="my-2 flex gap-1 items-start">
            <div className=" pt-5 font-bold text-4xl text-orange-500">
              <i className="fa-solid fa-message"></i>
            </div>

            <div className="ml-2">
              <h3 className="ml-2 my-2 font-bold">Message Me</h3>
              <p className="ml-2 text-gray-600 pr-8">
          ...
          <li className="my-2 flex gap-1 items-start">
            ...
            <div className="ml-2 flex flex-col">
              <h3 className="ml-2 my-2 font-bold">Current Location</h3>
          ...
          <li className="my-2 flex gap-1 items-start">
            ...
            <div className="ml-2 flex flex-col">
              <h3 className="ml-2 my-2 font-bold">Contact With Me</h3>
              <span className="ml-2 flex flex-row items-center gap-2 text-gray-600">
              ...
              <a className=" flex" href="mailto: abdurrahman.me7@gmail.com">
