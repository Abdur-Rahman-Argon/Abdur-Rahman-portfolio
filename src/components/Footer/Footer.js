...
const Footer = () => {
  ...
  return (
    <footer>
      <div class="footer footer-center py-4   shadow-2xl text-base-content">
        <div class="flex  flex-col md:flex-row md:mx-20 gap-5 lg:gap-20 text-white">
          <div class=" text-left w-8/12 mx-auto">
            <h1 class=" text-2xl font-medium my-5 md:my-2 lg:my-7">
              My Career
            </h1>
            <p class=" text-lg">
          ...
          <div class="flex-1 text-left">
            <h1 class=" text-2xl font-medium my-5">FOLLOW ME</h1>
            <div class="flex flex-row gap-8 my-5">
        ...
        <p class="text-white text-center flex items-center justify-center  w-full font-semibold text-xs md:text-lg">
          Copyright © {year} - All right reserved by
          <span class="text-orange-500"> Abdur Rahman</span>
        </p>
      </div>
    </footer>
  );
